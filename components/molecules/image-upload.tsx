...
export const ImageUpload: FC<{
  ...
  return (
    <label
      ...
      htmlFor="image"
      className={`flex bg-cover justify-center  items-center flex-col gap-2 pt-[61px] pr-[38px] pb-[60px] pl-[39px] rounded-xl ${
        image ? `` : "bg-light-purple"
      } ${image ? "text-white" : "text-purple"} `}
    >
      <input
        type="file"
      ...
      <p className=" text-heading-s">+ {image ? "Change" : "Upload"} Image</p>
    </label>
  );
};
